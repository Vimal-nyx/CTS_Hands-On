public class Forecast {
    public static void main(String[] args) {
        double startMoney = 1000.0; // start with $1000
        double[] growthRates = {0.05, 0.03, 0.06, 0.04, 0.05}; // growth rates for each year (5%, 3%...)
    ...
    // recursion helper to calculate year by year
